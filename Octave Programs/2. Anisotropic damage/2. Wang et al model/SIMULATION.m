...
ttype = 0;
[K,STRESSITERATION,STATEVITER,PNEW]     =UMAT(DELTAEPSMATRIX,STRESSSIM(:,end),STATEV,PARA,ttype);
...
%UMAT NEEDS: STRAIN INCREMENT  -->DU<--, OLD STRESS STATE STRESSSIM(:,end), OLD STATEV-VARIABLES, MATERIAL OR MODEL PARAMETERS PARA
        ...
        [K,STRESSITERATION,STATEVITER,PNEW]     =UMAT(DU,STRESSSIM(:,end),STATEV,PARA);
