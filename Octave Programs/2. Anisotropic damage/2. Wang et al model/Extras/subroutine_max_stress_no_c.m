function [sig6,A66,sdvl]=subroutine_max_stress_no_c(eps6,sdvl,ttype)
...
elseif ttype == 1
    ...
    for ieps=1:1:length(eps6)
        ...
        [sig6per,Adummy,sdvldummy] = subroutine_max_stress_no_c(epsper,sdvl,0);
