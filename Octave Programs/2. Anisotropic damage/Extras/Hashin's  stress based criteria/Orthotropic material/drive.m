...
data = [time; e11; s11; eps22; eps12;];

fileID = fopen('output.txt','w');
fprintf(fileID,'%2s %15s %15s %15s %15s\n','n','Epsilon_{11}','Sigma_{11}','Epsilon_{22}','Epsilon_{12}');
fprintf(fileID,'%25s\n','');
...
hold on
plot(e11,eps12,'g-')
legend('\epsilon_{22}','\epsilon_{12}','Ref.','Location','NorthEast')
xlabel('eps11')
ylabel('eps22, eps12')
